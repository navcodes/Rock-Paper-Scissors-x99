...
// create setPlayerMoves() and parameters for different values
function setPlayerMoves(player, moveOneType, moveOneValue, moveTwoType, 
    ...
    //create helper function isValidMoveType() with parameter of moveType to validate values.
    function isValidMoveType(moveType) {
        return (moveType === 'rock') || (moveType === 'paper') || (moveType === 'scissors');
    }

    // create helper function to accept argument of moveValue and check that it ranges from 1 to 99.
...
function getMoveWinner (playerOneMoveType, playerOneMoveValue, 
...
function getGameWinner () {
    ...
    // set playerOneWins and playerTwoWins values to 0
    playerOneWins = 0;
    playerTwoWins = 0;
